...
function modulus_scripts() {    
	...
	wp_enqueue_style( 'font-awesome', get_template_directory_uri() . '/css/all.css', array(), 5112 );
...
function modulus_admin_customizer_enqueue_scripts(){
	   ...
	   wp_enqueue_style( 
	    ...
	    wp_enqueue_style('fontawesome', get_template_directory_uri() . '/css/all.css', array(), 5112 );
}
