		...
		'widgets' => array(
			...
			'top-left' => array(
			    ...
			    'my_text' => array(
					...
					array(
					  'text'  => '<ul><li><i class="fas fa-envelope"></i>  <a href="mailto:information@mail.com">information@mail.com</a></li><li><i class="fas fa-phone"></i> Call Us:(1)118 234 678</li></ul>'
					)
				)
			),
			...
			'top-right' => array(
			    ...
			    'my_text' => array(
		        	...
		        	// Widget $instance -> settings 
					array(
					  'text'  => '<ul><li><i class="fas fa-map-marker-alt"></i>Street N1, 12345, Washington D.C</li></ul>'
					)
				),
			),
			'header-right' => array(
			    ...
			    'my_text' => array(
		        	...
		        	// Widget $instance -> settings 
					array(
					  'text'  => '<ul><li><a class="waves-effect waves-light rippler rippler-default" href="http://www.facebook.com/"><i class="fab fa-facebook"></i></a></li><li><a class="waves-effect waves-light rippler rippler-default" href="http://plus.google.com/"><i class="fab fa-google-plus"></i></a></li><li><a class="waves-effect waves-light rippler rippler-default" href="http://www.instagram.com/"><i class="fab fa-instagram"></i></a></li><li><a class="waves-effect waves-light rippler rippler-default" href="http://www.linkedin.com/"><i class="fab fa-linkedin-in"></i></a></li><li><a class="waves-effect waves-light rippler rippler-default" href="http://www.twitter.com/"><i class="fab fa-twitter"></i></a></li></ul>'
					)
				),
			),
			...
			'footer-3' => array(
			    ...
			    'my_text' => array(
					...
					array(
					  ...
					  'text'  => '<ul><li><i class="fas fa-map-marker-alt"></i> Po Box CT16122 Colin Street West, Australia </li><li><i class="fas fa-phone"></i> +123 456 7890</li><li><i class="fas fa-mobile-alt"></i> 03 5481 2221</li><li><i class="fas fa-envelope"></i> <a href="mailto:info@gmail.com">info@gmail.com</a></li></ul>'
					)
				)
			),
